...
- src/ - library root: main exports, config interfaces, SecureCrypto facade, HKDF derivation, helpers, mixins (encryption/hashing/keys/validation/guards, facade entry guards crypto.service.facade-guards.ts, bulk object-operations mixin crypto.service.bulk.ts, audit notifier crypto.service.audit.ts), and AuditLogger interface (audit.ts)
